$(document).ready(function () {
    ...
    $("#coupon_create").submit(function () {
        
        var couponname = $("#couponname").val();
        var coupondicount = $("#coupoundiscount").val();
        var validdate = $("#Expriydate").val();
        var maxdiscountamount = $("#maxdiscount").val();
        var mindiscountamount = $("#mindiscount").val();
        var No_timeuse = $("#Notimeuse").val();
        var area = $('#vendorarea').val();
        //var maxdiscamt = $("#Expriydate").val();
        //max_discountamount
        //minimum_amount
        // no_of_time_use
        //var mindisamt = $("#Expriydate").val();
        //var validdate = $("#Expriydate").val();
        $.ajax({
            url: "https://api.americanfragrances.com/coupons/create",
            type: "POST",
            data: { "Project_Id": Project_Id, "name": couponname, "discount": coupondicount, "authorid": ProjectAuth, "expiredon": validdate, "max_discountamount": maxdiscountamount, "minimum_amount": mindiscountamount, "no_of_time_use": No_timeuse, "area": area },
            dataType: "json",
            traditional: true,
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $.each(data, function (Index, value) {
                    ...
                    $("#tblcoupon_lst tbody").append(newrowContent);
                });
            }
        });
    };
    ...
    $(".edit").click(function () {
        ...
        $.ajax({
            url: "https://api.americanfragrances.com/coupons/EditCoupon?id=" + getid + "&project_id=" + Project_Id + "&authorid=" + ProjectAuth + "",
            type: "GET",
            dataType: "JSON",
            crossDomain: true,
            success: function (data) {
    ...
    $("#coupon_edit").submit(function () {
        ...
        if (validdate=="") {
            ...
            if (id != null) {
                $.ajax({
                    url: "https://api.americanfragrances.com/coupons/Edit",
                    type: "POST",
                    data: { "id": id, "Project_Id": Project_Id, "name": couponname, "discount": coupondicount, "authorid": ProjectAuth, "max_discountamount": maxdiscountamount, "minimum_amount": mindiscountamount, "no_of_time_use": No_timeuse, "id": id },
                    dataType: "json",
                    traditional: true,
                    success: function (data) {
            ...
            if (id != null) {
                $.ajax({
                    url: "https://api.americanfragrances.com/coupons/Edit",
                    type: "POST",
                    data: { "id": id, "Project_Id": Project_Id, "name": couponname, "discount": coupondicount, "authorid": ProjectAuth, "expiredon": validdate, "max_discountamount": maxdiscountamount, "minimum_amount": mindiscountamount, "no_of_time_use": No_timeuse, "id": id },
                    dataType: "json",
                    traditional: true,
                    success: function (data) {
    ...
    //---------------------------------------Delete Method-----------------------------------------//
    $("#tblcoupon_lst").on('click', ".Cat_Delete", function () {
