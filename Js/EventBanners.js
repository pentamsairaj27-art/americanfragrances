$(document).ready(function () {
    ...
    $("#Addcategory").submit(function () {
        ...
        reader.onloadend = function () {
            ...
            $.ajax({
                url: "https://api.americanfragrances.com/Banner/NewsEventCreate",
                type: "POST",
                data: { "image": imagestr },
                dataType: "json",
                traditional: true,
    ...
    $(".edit").click(function () {
        ...
        $.ajax({
            url: "https://api.americanfragrances.com/Banner/GetNewsEventBannerById?bannerId=" + getid,
            type: "GET",
            dataType: "JSON",
            crossDomain: true,
            success: function (data) {
    ...
    $("#cat_edit").submit(function () {
        ...
        var file = $("#edit_imgfile")[0].files[0];
            ...
            reader.onloadend = function () {
                ...
                imagestr = imagebase64;
                $.ajax({
                    url: "https://api.americanfragrances.com/Banner/UpdateNewsEventBanner",
                    type: "POST",
    ...
    $("#tbltesti_lst").on('click', ".Cat_Delete", function () {
        ...
        if (r == true) {
            var getid = $(this).attr("id");
            $.ajax({
                url: "https://api.americanfragrances.com/Banner/DeleteNewsEventBanner?id" + getid + "&project_id=" + Project_Id + "&AdminID=" + ProjectAuth + "",
                type: "POST",
                data: { "id": getid },
                dataType: "JSON",
                crossDomain: true,
