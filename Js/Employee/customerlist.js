$(document).ready(function () {
    ...
    function getdatatable() {
        $.ajax({
            url: "https://api.americanfragrances.com/Customer/Index?project_id=" + Project_Id + "&authorid=" + ProjectAuth,
            type: "GET",
            dataType: "JSON",
            async: false,
            crossDomain: true,
            success: function (data) {
                ...
                $.each(data, function (Index, value) {
                    ...
                    var newrowContent = "<tr><td class='custdetails' id= " + value.id + " ><span style='color:#147ad0!important;cursor:pointer!important;'>" + value.name + "</span> </td><td> " + value.email + " </td><td> " + value.phone + " </td> <td style='display:none!important'><span class='iconify viewdtls' data-icon='bi:cart3' data-inline='false' id=" + value.cart_id + " ></span><span>&nbsp;&nbsp;</span><span style='display:none' class='iconify' data-icon='la:file-invoice-solid' data-inline='false'></span></td></tr>"
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data != "" && data.id != "00000000-0000-0000-0000-000000000000") {
                            ...
                            $.each(data, function (Index, value) {
                                ...
                                if (i == 1) {
                                    ...
                                    if (value.isprimary == null) {
                                        ...
                                        if (chk) {
                                            var newrowContent = '<p><div class="row" style="margin-left:0px;"><div class="col-md-3">Address</div><div class="col-md-1">:</div><div class="col-md-8"> ' + value.address + ' , ' + value.city + ' , ' + value.state + ' ,' + value.pincode + '</div></div></p>'
                            ...
                            var newrowContent = '<table style="margin:0px auto!important"><tr><td><div class="icon_dv"><div class="lbl_icon_circle"></div></div></td><td><h6 class="txt_sm text-danger">Address has not been Added by this Customer</h6></td></tr></table>'
                            $("#Address_list").append(newrowContent);
                        }
