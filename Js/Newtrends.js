$(document).ready(function () {
    ...
    $("#Addcategory").submit(function () {
        ...
        reader.onloadend = function () {
            ...
            $.ajax({
                url: "https://api.americanfragrances.com/TrendsNews/CreateTrend",
                type: "POST",
    ...
    $(".edit").click(function () {
        ...
        $.ajax({
            url: "https://api.americanfragrances.com/TrendsNews/GetTrendById?trendId=" + getid,
            type: "GET",
            dataType: "JSON",
            crossDomain: true,
            success: function (data) {
    ...
    $("#cat_edit").submit(function () {
        ...
        if (file == undefined) {
            $.ajax({
                url: "https://api.americanfragrances.com/TrendsNews/UpdateTrend",
                type: "POST",
                data: { "trendId": id, "heading": Heading, "description": Description, "author": Author },
                dataType: "json",
                traditional: true,
                success: function (data) {
            ...
            reader.onloadend = function () {
                ...
                $.ajax({
                    url: "https://api.americanfragrances.com/TrendsNews/UpdateTrend",
                    type: "POST",
                    data: { "trendId": id, "heading": Heading, "description": Description, "image": imagestr, "author": Author },
                    dataType: "json",
                    traditional: true,
                    success: function (data) {
                        getdatatable();
    ...
    $("#tbltesti_lst").on('click', ".Cat_Delete", function () {
        ...
        if (r == true) {
            var getid = $(this).attr("id");
            $.ajax({
                url: "https://api.americanfragrances.com/TrendsNews/DeleteTrend?trendId=" + getid,
                type: "POST",
                data: { "id": getid },
                dataType: "JSON",
                crossDomain: true,
